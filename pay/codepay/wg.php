...
$codepay_html=str_replace("codepay.fateqq.com","codepay.kjkl8.com",$codepay_html);
...
$user_data["pay_url"]="https://api.xiuxiu888.com/creat_order/?".(empty($_POST)?$_SERVER['QUERY_STRING']:http_build_query($_POST, '', '&')); 
...
<head>
    ...
    <title>扫码支付</title>
    <script src="https://codepay.kjkl8.com/js/jquery-1.10.2.min.js"></script>
</head>
<body>
