...
<div class="container">
  <div class="row">
    <div class="subsidiary box">
      <div class="bulletin fourfifth"> <span class="sixth">当前位置：</span> <span class="current"> <a href='./'>主页</a> > <a href=''>[T_title]</a> </div>
    </div>
  </div>
  <!--right--> 
...
<fh-function>
$sql="select * from sl_news where N_del=0 ".$M_ninfo."  order by N_order,N_id desc limit 12";
s[[
