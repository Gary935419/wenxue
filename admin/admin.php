...
if($A_id!=""){
	$aa="edit&A_id=".$A_id;
	$A=getrs("select * from sl_admin where A_id=".$A_id);
	if ($A!="") {
		$A_head=$A["A_head"];
		$A_login=$A["A_login"];
		$A_part=$A["A_part"];
        ...
        $A2_4=splitx(splitx($A_part,"A2_4:",1),",",0);
...
if($action=="add"){
	...
	$A_part="A0_0:$A0_0,A1_0:$A1_0,A1_1:$A1_1,A1_2:$A1_2,A1_3:$A1_3,A1_4:$A1_4,A1_5:$A1_5,A2_0:$A2_0,A2_1:$A2_1,A2_2:$A2_2,A2_3:$A2_3,A2_4:$A2_4,A3_0:$A3_0,A3_1:$A3_1,A3_2:$A3_2,A3_3:$A3_3,A3_4:$A3_4,A4_0:$A4_0,A4_1:$A4_1,A4_2:$A4_2,A5_0:$A5_0,A5_1:$A5_1,A5_2:$A5_2,A5_3:$A5_3,A6_0:$A6_0,";
										...
										<div class="card-header">
											<h4>管理员列表</h4>
												...
												<ul class="list-group">
													<?php 
													if($A4_0x==1){
														$A=getlist("select * from sl_admin where A_del=0 order by A_id desc limit 20");
													}else{
														$A=getlist("select * from sl_admin where A_del=0 and A_id=".$_SESSION["A_id"]);
													}
																...
																foreach($A as $a){
																	...
																	echo "<a id=\"".$a["A_id"]."\" href=\"?A_id=".$a["A_id"]."\" class=\"list-group-item ".$active."\">
																	<div class=\"part\"><input type=\"checkbox\" name=\"id[]\" value=\"".$a["A_id"]."\"> ".$a["A_login"]."</div> 
																	<img src=\"".pic2($a["A_head"])."\" alt=\"<img src='".pic2($a["A_head"])."' width='300'>\" style=\"height:25px;border-radius:10px;\" class=\"pull-right\"></a>";
															}
													?>
												</ul>
									</div>
												...
												<div class="form-group row">
													...
													<div class="col-md-9">
														...
														<p>系统设置 →
															...
															<label><input type="checkbox" value="1" name="A1_5" <?php if($A1_5==1){echo "checked='checked'";}?>>前台菜单</label>
														</p>
														<p>后台管理 →
															<label><input type="checkbox" value="1" name="A2_2" <?php if($A2_2==1){echo "checked='checked'";}?>>文章管理</label>
                                                            <label><input type="checkbox" value="1" name="A2_4" <?php if($A2_4==1){echo "checked='checked'";}?>>价格管理</label>
														</p>
														<p>交易管理 →
