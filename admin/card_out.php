...
switch($_POST["order"]){
	...
	foreach(getlist("select * from sl_card,sl_csort where C_sort=S_id and C_del=0 order by $order") as $c){
			if($C_content==1){
				$content=$c["C_content"];
			}else{
				$content="";
				...
				<div class="app-content">
					<section class="section">
                    	<ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"><a href="card_out.php">导出卡密</a></li>
                        </ol>
                        <style type="text/css">
