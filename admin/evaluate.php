...
if($E_id!=""){
	$aa="reply&E_id=".$E_id;
	$E=getrs("select * from sl_evaluate,sl_orders,sl_member where E_mid=M_id and E_oid=O_id and E_id=".$E_id);
	if ($E!="") {
		$O_id=$E["O_id"];
		$O_pid=$E["O_pid"];
		$O_title=$E["O_title"];
		$O_pic=$E["O_pic"];
		$E_content=htmlspecialchars($E["E_content"]);
		$E_time=$E["E_time"];
		$E_reply=$E["E_reply"];
		$E_star=$E["E_star"];
		$M_login=$E["M_login"];
...
$E_counts=getrs("select count(E_id) as E_count from sl_evaluate,sl_orders,sl_member where E_mid=M_id and E_oid=O_id and E_del=0","E_count");
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div id="app">
			<div class="main-wrapper" >
				...
				<div class="app-content">
					...
					<a href="evaluate_add.php" class="btn btn-primary pull-right" style="z-index: 2;position: relative;margin-right: 5px;"><i class="fa fa-plus-circle"></i> 虚拟评价</a>
										...
										<div class="card-header">
											<h4>评价列表</h4>
												...
												<ul class="list-group">
													...
													<?php 
													foreach(getlist("select * from sl_evaluate,sl_orders,sl_member where E_mid=M_id and E_oid=O_id and E_del=0 order by E_id desc limit ".(($page-1)*20).",20") as $e){
																	...
																	echo "<a id=\"".$e["E_id"]."\" href=\"?E_id=".$e["E_id"]."\" class=\"list-group-item ".$active."\">
																	<div class=\"part\"><input type=\"checkbox\" name=\"id[]\" value=\"".$e["E_id"]."\"> [".$e["E_star"]."星] ".$e["E_content"]."</div> 
																	<div class=\"part\">".$e["O_title"]."</div> 
																	<div class=\"part\">".$e["E_time"]."</div> 
																	<img src=\"../media/".splitx($e["O_pic"],"|",0)."\" alt=\"<img src='../media/".splitx($e["O_pic"],"|",0)."' width='300'>\" style=\"height:25px;border-radius:10px;\" class=\"pull-right\"></a>";
										...
										<div class="card-body">
											<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-md-9" style="margin-top: 7px">
														<a href="../?type=productinfo&id=<?php echo $O_pid?>" target="_blank"><img src="../media/<?php echo splitx($O_pic,"|",0)?>" width="100"></a>
													</div>
												</div>
												<div class="form-group row">
...
function loadpage(id) {
    ...
    $.jqPaginator('#pagination', {
        ...
        onPageChange: function (num, type) {
            if (type == "change") {
                window.location="evaluate.php?action=menu&page="+num;
            }
        }
    });
}
