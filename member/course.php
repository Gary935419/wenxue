...
$sql="select count(O_id) as O_count from sl_orders where O_del=0 and O_mid=".$M_id." and O_type=2 order by O_id desc";
		...
		<div class="container m_top_30">
			...
			<div class="yto-box">
						...
						<div class="panel panel-default">
							<div class="panel-heading">课程记录</div>
							...
							$sql="select * from sl_orders where O_del=0 and O_mid=".$M_id." and O_type=2 order by O_id desc limit ".(($page-1)*10).",10";
							$result = mysqli_query($conn,  $sql);
