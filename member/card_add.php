								...
								<form id="form">
												<div class="form-group row">
													...
													<div class="col-md-10">
														...
														<div style="margin-top: 10px;font-size: 12px;color: #AAAAAA">*可以批量新增卡密，每行一个，可以智能去重复 <button class="btn btn-xs btn-info" onclick="txt()" type="button">导入txt</button></div>
													</div>
												</div>
...
?>
	...
	<script type="text/javascript">
		function txt(){
			$("#C_content").parent().append("<input type='file' id='fileId' name='file' style='display:none;' onchange='aaa()'/>");
