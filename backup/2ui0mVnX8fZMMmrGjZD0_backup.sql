-- 备份时间：2021-06-28 10:51:44 域名：www.t2.tx.com 备份者：admin 程序版本：v1.1_build20210624 电脑端：t4 手机端：t9 --;
...
insert into `sl_history`(`H_id`,`H_hid`,`H_hid2`,`H_type`,`H_mid`,`H_time`) values('2','189','0','1','13','2021-06-23 13:42:32');
insert into `sl_history`(`H_id`,`H_hid`,`H_hid2`,`H_type`,`H_mid`,`H_time`) values('3','188','0','1','13','2021-06-04 11:29:19');
...
insert into `sl_news`(`N_id`,`N_title`,`N_content`,`N_pic`,`N_price`,`N_sort`,`N_del`,`N_order`,`N_long`,`N_date`,`N_author`,`N_view`,`N_preview`,`N_mid`,`N_sh`,`N_tag`,`N_fx`,`N_video`,`N_top`,`N_tpl`,`N_shuxing`,`N_keywords`,`N_description`,`N_price2`,`N_vshow`,`N_ds`,`N_dsintro`,`N_uncopy`,`N_sort2`,`N_viponly`,`N_content_en`,`N_content_jp`,`N_content_kor`,`N_content_ru`,`N_content_de`,`N_content_spa`,`N_content_fra`,`N_content_ara`) values('188','艺术测试','<p>
	的开发进度款减肥的
</p>
<p>
	都快放假多考几分
...
<p>
	会计法德生科技f咖啡机看到
</p>','2021061911411767.png','1.00','53','0','0','0','2021-06-19 11:26:31','admin','14','0','0','1','','0','','0','0','','','','0.00','0','0','','0','52','1','','','','','','','','');
insert into `sl_news`(`N_id`,`N_title`,`N_content`,`N_pic`,`N_price`,`N_sort`,`N_del`,`N_order`,`N_long`,`N_date`,`N_author`,`N_view`,`N_preview`,`N_mid`,`N_sh`,`N_tag`,`N_fx`,`N_video`,`N_top`,`N_tpl`,`N_shuxing`,`N_keywords`,`N_description`,`N_price2`,`N_vshow`,`N_ds`,`N_dsintro`,`N_uncopy`,`N_sort2`,`N_viponly`,`N_content_en`,`N_content_jp`,`N_content_kor`,`N_content_ru`,`N_content_de`,`N_content_spa`,`N_content_fra`,`N_content_ara`) values('189','艺术测试1','颠三倒四','202106191141445O.jpg','1.00','53','0','0','0','2021-06-19 11:41:36','admin','93','0','0','1','','0','','0','0','','','','0.00','0','0','','0','52','1','','','','','','','','');
