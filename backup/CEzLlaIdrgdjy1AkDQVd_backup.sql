-- 备份时间：2021-07-01 14:19:36 域名：www.t2.tx.com 备份者：admin 程序版本：v1.1_build20210517 电脑端：t4 手机端：t9 --;
...
insert into `sl_log`(`L_id`,`L_time`,`L_add`,`L_ip`,`L_title`,`L_del`,`L_aid`) values('450','2021-06-29 09:28:38','CHINA','127.0.0.1','后台登录成功','0','1');
insert into `sl_log`(`L_id`,`L_time`,`L_add`,`L_ip`,`L_title`,`L_del`,`L_aid`) values('451','2021-06-29 09:45:13','CHINA','127.0.0.1','新增文章','0','1');
insert into `sl_log`(`L_id`,`L_time`,`L_add`,`L_ip`,`L_title`,`L_del`,`L_aid`) values('452','2021-06-29 09:48:44','CHINA','127.0.0.1','新增文章','0','1');
insert into `sl_log`(`L_id`,`L_time`,`L_add`,`L_ip`,`L_title`,`L_del`,`L_aid`) values('453','2021-06-29 09:50:21','CHINA','127.0.0.1','新增文章','0','1');
...
insert into `sl_news`(`N_id`,`N_title`,`N_content`,`N_pic`,`N_price`,`N_sort`,`N_del`,`N_order`,`N_long`,`N_date`,`N_author`,`N_view`,`N_preview`,`N_mid`,`N_sh`,`N_tag`,`N_fx`,`N_video`,`N_top`,`N_tpl`,`N_shuxing`,`N_keywords`,`N_description`,`N_price2`,`N_vshow`,`N_ds`,`N_dsintro`,`N_uncopy`,`N_sort2`,`N_viponly`,`N_content_en`,`N_content_jp`,`N_content_kor`,`N_content_ru`,`N_content_de`,`N_content_spa`,`N_content_fra`,`N_content_ara`) values('210','1','顶顶顶顶','nopic.png','0.00','53','0','0','0','2021-06-29 09:49:30','admin','0','0','0','0','','0','','0','0','','','','0.00','0','0','','0','52','0','Top top top','天井裏','꼭대기','вершина','Oben oben','Top Top Top','Top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top top','أعلى قمة');
